...
func TestSequentialStrategy_Execute(t *testing.T) {
	...
	if collector.callCount != 3 {
		t.Errorf("Expected 3 calls to collector, got %d", collector.callCount)
	}
}
...
func TestSequentialStrategy_ContextCancellation(t *testing.T) {
	...
	if collector.callCount >= 5 {
		t.Errorf("Expected fewer than 5 calls due to cancellation, got %d", collector.callCount)
	}
}
...
func TestParallelStrategy_Execute(t *testing.T) {
	...
	if collector.callCount != 4 {
		t.Errorf("Expected 4 calls to collector, got %d", collector.callCount)
	}
...
func TestAdaptiveStrategy_Execute(t *testing.T) {
	...
	if collector.callCount != 5 {
		t.Errorf("Expected 5 calls to collector, got %d", collector.callCount)
	}
}
