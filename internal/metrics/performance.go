...
var (
	...
	performanceGCDuration = promauto.NewHistogram(prometheus.HistogramOpts{
		Name:    "tsmetrics_performance_gc_duration_seconds",
	...
	performanceLoadAverage = promauto.NewGaugeVec(prometheus.GaugeOpts{
		Name: "tsmetrics_performance_load_average",
